...
public class BalanceApiController implements BalanceApi {
    ...
    public ResponseEntity<Response> balanceGet(@NotNull @Parameter(in = ParameterIn.QUERY, description = "Account address." ,required=true,schema=@Schema()) @Valid @RequestParam(value = "address", required = true) String address) {
        String accept = request.getHeader("Accept");
        if (accept != null) {
            Response res = new Response();
            res.setResponse(BCGateway.getBalance(address));
