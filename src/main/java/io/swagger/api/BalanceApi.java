...
public interface BalanceApi {
    ...
    ResponseEntity<Response> balanceGet(@NotNull @Parameter(in = ParameterIn.QUERY, description = "Account address." ,required=true,schema=@Schema()) @Valid @RequestParam(value = "address", required = true) String address);
